...
- `store`: a custom store to track requests and rates, for an example custom store please see the [`example/`](https://github.com/fastify/fastify-rate-limit/tree/master/example) folder
