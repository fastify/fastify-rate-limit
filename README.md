...
- `ban`: is the maximum number of 429 responses to return to a single client before returning 403. When the ban limit is exeeded the context field will have `ban=true` in the errorResponseBuilder
